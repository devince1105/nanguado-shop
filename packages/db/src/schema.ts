...
export const orders = pgTable("orders", {
  ...
  invoiceType: varchar("invoice_type", { length: 20 }).notNull().default("individual"),
  carrierType: varchar("carrier_type", { length: 20 }),
  carrierNum: varchar("carrier_num", { length: 50 }),
  companyTaxId: varchar("company_tax_id", { length: 8 }),
