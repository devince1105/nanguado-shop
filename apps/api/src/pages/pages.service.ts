...
export const KNOWN_PAGES: { slug: string; title: string; content: string }[] = [
  {
    ...
    title: "品牌故事",
    content:
      "# 品牌故事\n\n南瓜多 本舖 是一間台灣原創設計商店，把台灣的風景、動物與生活風格穿在身上。\n\n（請在後台編輯這段內容，講述你的品牌故事。）",
  },
  {
    slug: "terms",
    title: "服務條款",
    content:
      "# 服務條款\n\n歡迎使用南瓜多 本舖。使用本網站即表示您同意以下條款。\n\n（請在後台補充完整條款，例如帳號、訂購、付款、智慧財產權等內容。）",
  },
  {
    slug: "returns",
    title: "退換貨政策",
...
歡迎使用南瓜多 本舖。本聲明說明本網站如何蒐集、處理、利用及保護您的個人資料，以及您使用本網站時應遵守的條款。當您使用本網站與服務，即表示您已閱讀並同意本聲明。

## 一、適用範圍

本聲明適用於您在南瓜多 本舖 網站瀏覽、註冊會員、下單購物及使用相關服務之情形；不適用於本網站以外之連結網站。
